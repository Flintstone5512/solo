...
export const categories = [
  { id: 1, icon: Cate1, names: "Account and Card" },
  { id: 2, icon: Cate2, names: "Transfer" },
  { id: 3, icon: Cate3, names: "Withdraw" },
  { id: 4, icon: Cate4, names: "Mobile prepaid" },
  { id: 5, icon: Cate5, names: "Pay the bill" },
  { id: 6, icon: Cate6, names: "Save online" },
  { id: 7, icon: Cate7, names: "Credit card" },
  { id: 8, icon: Cate8, names: "Transaction report" },
  { id: 9, icon: Cate9, names: "Beneficiary" },
];

export const send_money = [
  { id: 1, image: Money1, name: "Minato" },
  { id: 2, image: Money2, name: "Minato" },
  { id: 3, image: Money3, name: "Minato" },
  { id: 4, image: Money4, name: "Minato" },
  { id: 5, image: Money5, name: "Minato" },
];
...
export const progressive_days = [
  { id: 1, time: "Sun", percentage: 70, color: "#3629B7" },
  { id: 2, time: "Mon", percentage: 50, color: "#0890FE" },
  { id: 3, time: "Tue", percentage: 60, color: "#3629B7" },
  { id: 4, time: "Wed", percentage: 40, color: "#0890FE" },
  { id: 5, time: "Thu", percentage: 80, color: "#3629B7" },
  { id: 6, time: "Fri", percentage: 90, color: "#0890FE" },
  { id: 7, time: "Sat", percentage: 30, color: "#3629B7" },
];

export const transaction_tabs = [
  { id: 1, icon: Credit, text: "Credited", price: "$564,30" },
  { id: 2, icon: Debit, text: "Debited", price: "$564,30" },
];

export const donet_datas = [
  { id: 1, text: "Foods", color: "#E7E7E7" },
  { id: 2, text: "Shopping", color: "#FB6B18" },
  { id: 3, text: "Topup", color: "#0890FE" },
  { id: 4, text: "Bills", color: "#FF4267" },
];

export const options = [
  { id: 0, option: "VISA **** **** **** 1234" },
  { id: 1, option: "VISA **** **** **** 1234" },
];
...
export const beneficar_data = [
  { id: 1, image: Beneficar1, name: "Emma" },
  { id: 2, image: Beneficar2, name: "Justin" },
];
...
export const options2 = [
  { id: 0, option: "JPMorgan Chase" },
  { id: 1, option: "Bank of America" },
  { id: 2, option: "Citigroup" },
  { id: 3, option: "Wells Fargo" },
  { id: 4, option: "Goldman Sachs" },
];
...
export const profile_data = [
  { id: 1, icon: Profile1, active_icon: Dark_profile1, name: "Edit Profile" },
  { id: 2, icon: Profile2, active_icon: Dark_profile2, name: "Your favorite songs" },
  { id: 3, icon: Profile3, active_icon: Dark_profile3, name: "Dark Mode" },
  { id: 4, icon: Profile4, active_icon: Dark_profile4, name: "Help & Support" },
  { id: 5, icon: Profile5, active_icon: Dark_profile5, name: "Language" },
];
